...
import { w as formatCurrency } from "./_ssr/router-C3pqRbRf.mjs";
import { L as Link } from "./_libs/tanstack__react-router.mjs";
import { o as orders, a as clients } from "./_ssr/mock-data-DefFmkSt.mjs";
import "./_libs/sonner.mjs";
import { h as Boxes, d as ArrowRight, j as ChartColumn } from "./_libs/lucide-react.mjs";
...
function Relatorios() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 md:px-10 py-8 max-w-[1400px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 rounded-2xl border border-border bg-white p-5 flex flex-col md:flex-row items-center justify-between gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 rounded-2xl border border-dashed border-border p-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "size-6 text-muted-foreground mx-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Relatórios completos (funil, SLA, lucro por processo) na Sprint 2." })
    ] })
  ] });
}
function Stat({
