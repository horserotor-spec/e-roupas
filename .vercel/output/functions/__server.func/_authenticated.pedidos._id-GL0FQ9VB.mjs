...
import { P as Popover, l as PopoverTrigger, B as Button, v as cn, k as PopoverContent, C as Command, c as CommandInput, e as CommandList, a as CommandEmpty, b as CommandGroup, d as CommandItem, s as Route$8, y as supabase, D as Dialog, f as DialogContent, i as DialogHeader, j as DialogTitle, h as DialogFooter } from "./_ssr/router-BxmJvJdu.mjs";
...
import { b as useCreateProductFromBOM, f as useProducts, g as getProductDisplayName } from "./_ssr/product-display-OekIbBbT.mjs";
import { C as ClientFormDrawer } from "./_ssr/ClientFormDrawer-CtGI2pCo.mjs";
import { h as useUpdateOrder } from "./_ssr/orders-CbTRcciT.mjs";
import { t as toast } from "./_libs/sonner.mjs";
import { o as ChevronsUpDown, k as Check, V as LoaderCircle, c as ArrowLeft, aa as Printer, am as Tag, a9 as Plus, az as WandSparkles, ac as Save, an as Trash2 } from "./_libs/lucide-react.mjs";
...
import "./_ssr/sheet-BhiMmhDE.mjs";
import "./_ssr/checkbox-J9E3BJfJ.mjs";
...
function EditOrderPage() {
  ...
  const [loadingOrder, setLoadingOrder] = reactExports.useState(true);
  const [initialLoaded, setInitialLoaded] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    supabase.from("orders").select("*, order_items(*), order_payments(*)").eq("id", id).single().then(({
      data
    }) => {
      if (data) {
        setFormData({
        ...
        if (data.order_payments && data.order_payments.length > 0) {
          setPayments(data.order_payments.map((p) => ({
            ...p,
          ...
          setPayments([{
            amount: data.final_total || 0,
            payment_method: data.payment_method || "PIX",
            installments: 1,
            due_date: data.sale_date ? data.sale_date.substring(0, 10) : (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
            status: "pendente",
            notes: ""
          }]);
        ...
        if (data.order_items) {
          ...
          data.order_items.forEach((item) => {
            const existing = grouped.find((g) => g.product_id === item.product_id && g.gender === item.gender && g.art_code === item.art_code && JSON.stringify(g.customizations) === JSON.stringify(item.customizations) && g.unit_price === item.unit_price && g.list_price === item.list_price);
            if (existing) {
              if (item.size) {
              ...
              if (item.art_code && baseSku.includes(item.art_code)) {
                ...
                if (parts[0] === item.art_code || parts[0] === "PF") {
                  parts.shift();
                  if (parts[0] === item.art_code) parts.shift();
                  baseSku = parts.join("-");
                }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("min-h-screen bg-slate-50 pb-20", printLayout !== "none" && "no-print"), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border-b sticky top-0 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-xl font-semibold text-slate-800", children: [
            formData.status === "orcamento" ? "Orçamento -" : "Pedido de venda -",
            " ",
            formData.code
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          formData.status === "orcamento" && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "h-7 px-3 text-xs rounded-full border-primary text-primary hover:bg-primary/5", onClick: () => {
            setFormData({
              ...formData,
              status: "atendimento"
            });
            toast.info("Clique em Salvar Alterações para confirmar a transformação em pedido.");
          }, children: "Transformar em Pedido" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "h-7 px-3 text-xs rounded-full border-emerald-600 text-emerald-600 hover:bg-emerald-50", onClick: () => {
...
${url}`;
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "h-7 px-3 text-xs rounded-full border-blue-600 text-blue-600 hover:bg-blue-50", onClick: () => handlePrint("pedido"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "size-3.5 mr-1.5" }),
            " Imprimir Pedido"
          ] }),
          formData.status !== "orcamento" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "h-7 px-3 text-xs rounded-full border-purple-600 text-purple-600 hover:bg-purple-50", onClick: () => handlePrint("etiqueta"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "size-3.5 mr-1.5" }),
            " Etiqueta de Envio"
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleSubmit, disabled: updateMutation.isPending, className: "h-7 px-5 text-xs rounded-full bg-green-600 hover:bg-green-700 text-white shadow-sm", children: [
            updateMutation.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-1.5 size-3.5 animate-spin" }),
            "Salvar Alterações"
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 py-8 space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-5 gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Canal de Origem *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: formData.origin_channel || "Internet", onValueChange: (v) => setFormData({
                ...formData,
                origin_channel: v
              }), children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Representante", children: "Representante" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SearchableCombobox, { items: (clients || []).filter((c) => c.entity_type === "vendedor").map((c) => ({
                id: c.id,
                name: c.name
              })), value: formData.seller_id || "", onChange: (v) => setFormData({
                ...formData,
                seller_id: v
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border rounded-lg overflow-x-auto overflow-y-visible mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm text-left", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y text-xs", children: [
                loadingOrder && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, className: "px-4 py-12 text-center text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center items-center gap-2", children: [
                ...
                !loadingOrder && items.map((item, idx) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-slate-50/50", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-2 py-2 space-y-2 align-top", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchableCombobox, { items: (products || []).map((p) => ({
                        id: p.id,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 flex-wrap items-center", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "h-8 text-xs font-mono w-28", placeholder: "Código Base", value: item.sku || "", onChange: (e) => updateItem(idx, "sku", e.target.value) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `font-bold ${payments.reduce((acc, p) => acc + (p.amount || 0), 0) === finalTotal ? "text-green-600" : "text-red-500"}`, children: [
                "R$ ",
    ...
    printLayout === "pedido" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "print-only p-8 text-black bg-white max-w-[210mm] mx-auto min-h-[297mm]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-end border-b-2 border-black pb-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo.png", alt: "Logo", className: "h-10 object-contain mb-2", onError: (e) => {
            e.currentTarget.style.display = "none";
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", children: "E-roupas Lab Têxtil Ltda." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "CNPJ: 18.288.318/0001-85 | (43) 3357-0809" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "Rua Etienne Lenoir, 71 - Industrial - Londrina - PR - CEP 86063-380" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "Pedido de Venda / Ordem de Produção" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-xl", children: formData.code }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-8 mb-8 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold border-b border-gray-300 mb-2 uppercase text-xs", children: "Dados do Cliente" }),
          (() => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              clientObj?.company_name && clientObj.company_name !== clientObj.name && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Razão Social:" }),
                " ",
                clientObj.company_name
              ] }),
              clientObj?.document && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "CPF/CNPJ:" }),
                " ",
                clientObj.document
              ] }),
              (clientObj?.phone || clientObj?.landline_phone) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Telefone:" }),
                " ",
                clientObj.phone || clientObj.landline_phone
              ] }),
              clientObj?.email && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Email:" }),
                " ",
                clientObj.email
              ] }),
              (clientObj?.street || clientObj?.city) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-gray-600 mt-1.5 border-t border-dashed pt-1 leading-normal", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Endereço:" }),
                " ",
                clientObj.street,
                clientObj.number ? `, ${clientObj.number}` : "",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Marca (Brand):" }),
            " ",
            brands?.find((b) => b.id === formData.brand_id)?.name || "-"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold border-b border-gray-300 mb-2 uppercase text-xs", children: "Informações Comerciais" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Vendedor:" }),
            " ",
            formData.seller_id || "Não informado"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Previsão Entrega:" }),
            " ",
            formData.expected_date ? new Date(formData.expected_date).toLocaleDateString("pt-BR") : "-"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Frete:" }),
            " ",
            formData.freight_payer,
            " | ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Transp:" }),
            " ",
            formData.carrier_name || "Correios/Retirada"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Forma de Pagamento:" }),
            " ",
            payments?.[0]?.payment_method || formData.payment_method || "PIX"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold border-b border-gray-300 mb-2 uppercase text-xs", children: "Itens do Pedido (Ficha Técnica)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm text-left border-collapse border border-gray-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-2 w-12", children: "Qtd" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-2", children: "Produto Base" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-2", children: "Detalhes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-2 w-24 text-right", children: "Unit R$" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-2 w-24 text-right", children: "Total R$" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: items.map((item, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "print-break-inside-avoid", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-2 align-top text-center font-bold", children: qtyTotal }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "border border-gray-300 p-2 align-top", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold", children: item.product_name }),
                sizesEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex flex-col gap-1", children: sizesEntries.map(([sz, q]) => {
                  let itemSku = item.sku || "";
                  if (itemSku.startsWith("PA-")) {
                    itemSku = itemSku.replace("PA-", `${item.art_code}-`);
                  } else {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-slate-600 font-mono", children: [
                    "[",
                    finalSku,
                    "] — ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-2 align-top", children: hasCustomizations ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs space-y-1", children: item.customizations?.map((cust, ci) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                "• ",
                cust.quantity,
                "x ",
                cust.name,
              ...
              ] }, ci)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 text-xs", children: "Liso / Sem personalização" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-2 align-top text-right number", children: (item.unit_price || 0).toLocaleString("pt-BR", {
                minimumFractionDigits: 2
              }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-2 align-top text-right number", children: ((item.unit_price || 0) * qtyTotal).toLocaleString("pt-BR", {
                minimumFractionDigits: 2
              }) })
            ] }, i);
          }) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-8 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold border-b border-gray-300 mb-2 uppercase text-xs", children: "Observações Impressas" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "whitespace-pre-wrap", children: formData.notes || "Nenhuma observação." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-b border-gray-200 py-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "Subtotal Produtos:" }),
            " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-b border-gray-200 py-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "Descontos:" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "- R$ ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-b border-gray-200 py-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "Frete/Outros:" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "+ R$ ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between py-2 text-lg font-bold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold border-b border-gray-300 mb-2 uppercase text-xs", children: "Forma de Pagamento / Parcelas" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left border-collapse border border-gray-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-gray-50 text-gray-700", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-1.5 font-bold w-12 text-center", children: "#" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-1.5 font-bold", children: "Valor (R$)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-1.5 font-bold", children: "Forma" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border border-gray-300 p-1.5 font-bold", children: "Data Venc." })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: (payments || []).map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-gray-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-1.5 text-center", children: idx + 1 }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "border border-gray-300 p-1.5 font-medium", children: [
              "R$ ",
              Number(p.amount || 0).toLocaleString("pt-BR", {
                minimumFractionDigits: 2
              })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-1.5", children: p.payment_method || "PIX" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border border-gray-300 p-1.5", children: p.due_date ? p.due_date.split("-").reverse().join("/") : "—" })
          ] }, idx)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex justify-between gap-8 pt-8 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[45%] text-center border-t border-gray-400 pt-2 text-xs", children: "Assinatura do Vendedor / Responsável" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[45%] text-center border-t border-gray-400 pt-2 text-xs", children: "De acordo do Cliente (Ok / Assinatura)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-xs text-gray-500 mt-16 border-t border-gray-300 pt-4", children: [
        "Documento gerado pelo sistema ERP em ",
        (/* @__PURE__ */ new Date()).toLocaleString("pt-BR")
      ] })
    ] }),
    printLayout === "etiqueta" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "print-only text-black bg-white", style: {
      width: "100mm",
      minHeight: "150mm",
      padding: "8mm",
      margin: "0 auto",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b-2 border-black pb-2 mb-2 flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo.png", alt: "Logo", className: "h-6 object-contain mb-1", onError: (e) => {
          e.currentTarget.style.display = "none";
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold mt-1", children: "E-roupas Lab Têxtil Ltda." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-600", children: "CNPJ: 18.288.318/0001-85 | (43) 3357-0809" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-gray-600 text-center", children: [
          "Rua Etienne Lenoir, 71 - Industrial",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Londrina - PR - CEP 86063-380"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[10px] uppercase font-bold mt-2", children: "Declaração de Conteúdo / Envio" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[10px] uppercase text-gray-600 mb-1 border-b border-gray-300", children: "Remetente" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold", children: "E-roupas Lab Têxtil Ltda." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 border-2 border-black p-2 rounded", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[10px] uppercase text-gray-600 mb-1 border-b border-gray-300", children: "Destinatário" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold uppercase", children: clients?.find((c) => c.id === formData.client_id)?.name }),
        clients?.find((c) => c.id === formData.client_id)?.company_name && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", children: [
          "A/C: ",
          clients?.find((c) => c.id === formData.client_id)?.company_name
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "(Verificar endereço no cadastro principal)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-black p-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-600", children: "Volumes:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-center text-base", children: [
            formData.volumes_quantity || "1",
            " vol"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-black p-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-600", children: "Pedido nº:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-center text-base", children: formData.code })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-black p-1 col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-600", children: "Transportadora:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-center uppercase", children: formData.carrier_name || "Correios" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-full bg-repeating-linear-gradient(to right, #000, #000 2px, transparent 2px, transparent 4px, #000 4px, #000 5px, transparent 5px, transparent 8px)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] mt-1 tracking-[0.2em]", children: formData.code })
      ] })
    ] }),
