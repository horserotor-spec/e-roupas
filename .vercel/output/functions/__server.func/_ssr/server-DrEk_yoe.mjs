...
import { k as defineHandlerCallback, M as resolveManifestAssetLink, N as resolveManifestCssLink, O as rootRouteId, q as getNormalizedURL, r as getOrigin, H as normalizeSsrResponse, c as attachRouterServerSsrUtils, g as createSerializationAdapter, f as createRawStreamRPCPlugin, w as invariant, z as isNotFound, A as isRedirect, C as isResolvedRedirect, L as replaceSsrResponse, G as mergeHeaders, n as executeRewriteInput, P as stripSsrResponseBody, j as defaultSerovalPlugins, F as makeSerovalPlugin, s as getScriptPreloadAttrs, u as getStylesheetHref, E as isSsrResponse } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D71Zw4Q2.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BxmJvJdu.mjs").then((n) => n.x),
    import("./start-mrpW7YZc.mjs"),
