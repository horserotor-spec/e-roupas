...
import { B as Button, w as formatCurrency } from "./_ssr/router-BxmJvJdu.mjs";
import { u as useClients, b as useImportClients } from "./_ssr/clients-Kv3wTwQs.mjs";
...
import "./_ssr/input-D9Pn2b9A.mjs";
import "./_ssr/label-Dffz--9m.mjs";
import "./_libs/radix-ui__react-label.mjs";
import "./_ssr/textarea-CZ4oHjug.mjs";
import "./_ssr/select-WVGuRtcH.mjs";
...
import "./_ssr/switch-B1byUmMA.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 md:px-10 py-8 max-w-[1400px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/40 text-xs uppercase tracking-wider text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left font-medium px-4 py-2.5 hidden lg:table-cell", children: "Cliente Desde" }),
        ...
        !isLoading && filtered.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-muted/30 transition-colors group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              c.code && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-md bg-muted px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground font-mono", children: c.code })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden lg:table-cell text-muted-foreground", children: c.created_at ? new Date(c.created_at).toLocaleDateString("pt-BR") : "—" }),
